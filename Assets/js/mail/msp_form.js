...
document.getElementById('mspForm').addEventListener('submit', (e) => {
  ...
  const formData = {
    ...
    businessNumber: document.getElementById('input5').value,
    ...
    // selectedServicesNeeded: Array.from(document.querySelectorAll('#mspForm .form-group:nth-child(5) .form-check-input'))
    ...
    // selectedSLA: Array.from(document.querySelectorAll('#mspForm .form-group:nth-child(8) .form-check-input'))
    //     .filter(checkbox => checkbox.checked)
    //     .map(checkbox => checkbox.nextElementSibling.textContent.trim()),
    // customSLA: document.getElementById('customSLA').value ? document.getElementById('customSLA').value : "None",
    // selectedBudgetRange: Array.from(document.querySelectorAll('#mspForm .form-group:nth-child(10) .form-check-input'))
    //     .filter(checkbox => checkbox.checked)
    //     .map(checkbox => checkbox.nextElementSibling.textContent.trim()),
    // selectedHowYouHeard: Array.from(document.querySelectorAll('#mspForm .form-group:nth-child(11) .form-check-input'))
    //     .filter(checkbox => checkbox.checked)
    //     .map(checkbox => checkbox.nextElementSibling.textContent.trim()),
